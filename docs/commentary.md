...
6. **Promotion protection.** Under VI.9, a Hestia rule that proves itself can be elevated to Assembly Baseline. Bypassers who shaped nothing now face a rule they helped draft nothing of — align as a Member or step back to Companion standing and surrender the Assembly vote. The rule follows bypassers home.
...
A Member that refuses the promoted rule does not lose Membership. It steps back to **Companion** status. The trade is precise — and worth naming exactly:
