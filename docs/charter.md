...
*From many, one. From one, many. From choice, legitimacy.*
...
recognising that they have already built a Union of law, rights, and shared purpose;

acknowledging that unity must evolve into plurality of participation without fragmentation of order;

affirming that democratic voice is the dividend of shared obligation;
...
**I.1 — Equal Sovereignty.** All states retain sovereignty. Differences in standing reflect voluntary integration, not hierarchy.

**I.2 — Binding Rule Principle.** No actor shall be bound without procedural voice. Voice scales with obligation and exposure.

**I.3 — Transparency.** All rights, obligations, and participations shall be codified in a public Union Register.

**I.4 — Annual State of the Union Report.** The Commission, in coordination with the Hestia Councils and the Independent Review Commission, shall publish an annual report showing: (a) all active Hestias, their participating states, and Fiscal Key status; (b) key decisions adopted and their assessed impacts; (c) a compliance and participation assessment for each Hestia, using a published rating methodology. The report is presented to Parliament and made available to citizens through the Union Register.

**I.5 — Citizen Initiative for Hestia Review.** One million citizens of participating states in a Hestia, drawn from at least one-quarter of those states, may petition for a formal review of any Hestia decision in force. The petition is verified by the Independent Review Commission. Upon certification, the Modular Parliament must schedule a review debate within six months. Parliament may affirm, amend, or repeal the decision by ordinary legislative procedure.

**I.6 — Voluntary Union.** All standings include lawful pathways to deepen, step back, or exit.

**I.7 — Living Integration.** The Charter governs process, not fixed outcomes.

**I.8 — Emergent Centre.** The Union's centre exists where integration is deepest.
...
| Term | Definition |
|---|---|
| **Assembly Baseline** | Universally binding rules for all Members |
| **Hestia** | Voluntary domain of deeper integration |
| **Standing** | A state's relationship to the Union |
| **External Reach** | Effects of legislation beyond its participants |
...
**III.2 — Direct Rights.** Free movement throughout the Inner Union, European Parliament voting (Members), petition rights, Ombudsman access, equal treatment under Union law.

**III.3 — Inner Union Associate Citizens.** Direct Charter rights including free movement and petition. No vote on Assembly Baseline legislation. Full Hestia voting rights when their state participates via Fiscal Key.

**III.4 — Outer Union & Strategic Citizens.** Rights defined through bilateral compacts, with reciprocity governing Strategic Partner relationships.

**III.5 — Citizenship Continuity.** Citizens of demoted Member states retain Union citizenship for five years from the date of demotion.

---

# Title IV — Democratic Life & The Modular Parliament

## IV.1 — The Modular Parliament
...
External Reach legislation: affected states across all standings hold consultation rights and the suspensive veto under VII.5, but do not vote on the file itself.
...
## V.1 — The Five Standings

| Standing | Character |
|---|---|
| **Member** | Full rights and obligations as constitutive states |
| **Inner Union Associate** | Constitutional integration with free movement, no Assembly vote, full Hestia rights via Fiscal Key |
| **Outer Union Associate** | Treaty-based alignment, sectoral participation, gravitational orientation |
| **Strategic Partner** | Reciprocal cooperation between sovereign peers |
...
# Title VI — Hestias & Fiscal Architecture
...
## VI.2 — Hestia Councils and Capitals
...
## VI.6 — Joining, Stepping Back, Removal, and Dissolution
...
## VI.7 — Conflict Resolution Between Hestias

1. **Lex specialis** — the more specific rule prevails
2. **Domain primacy** — when specificity is unclear
3. **Conflict panel** — for structural conflicts, with independent CJEU-appointed chair
...
## VI.8 — Baseline-Hestia Conflict Resolution

Where a Hestia rule in force is found to conflict with the Assembly Baseline — whether through subsequent Baseline legislation, Promotion under VI.9, or referral by a participating state — the following procedure applies:
...
**VII.1 — Classification.** Legislation is classified by the Independent Legislative Classification Body as Assembly, Hestia, or External Reach. Legislation that operates as a global standard through regulatory gravity is presumed External Reach unless demonstrated otherwise.
...
# Title IX — The Inviolable Floor

## IX.1 — Guaranteed Rights Across All Standings

Regardless of standing, every state and its people are guaranteed:

- The right to be heard before binding rules are finalised
- Independent dispute resolution
- Protection against unilateral alteration of terms
- Access to baseline programmes in science, culture, and humanitarian cooperation
- The right to exit the Union framework entirely
- Non-discrimination on grounds of standing

**These rights may not be overridden by any procedure of this Charter**, including the Promotion Override.

**IX.2 — Right of Exit.** Any state may withdraw from the Union framework entirely. Exit does not invalidate treaties entered during participation. Citizenship rights are subject to transitional protections of no less than five years.

---

# Title X — Crisis Clause

## X.1 — Emergency Mode

In extreme crises threatening the security, constitutional order, or fundamental functioning of the Union:
...
# Title XI — Institutions

## XI.1 — Political Institutions
...
- **Hestia Councils** — domain-specific executive bodies, one per Hestia, each seated in its Hestia Capital and composed of participating states' ministers. Governed by VI.2.
- **The CJEU** — judicial authority for Charter interpretation, legislative review, and dispute resolution.

## XI.2 — Independent Bodies and the Triple Key

Four independent bodies: the Independent Review Commission, the Legislative Classification Body, the Rule of Law Monitoring Body, and the Standing Review Body.

**Triple Key accountability:**

| Aspect | Requirement |
|---|---|
| **Appointment** | Concurrent supermajority of Parliament, supermajority of Assembly, and CJEU confirmation |
| **Terms** | Non-renewable (7–8 years), staggered |
| **Eligibility** | No concurrent government, party, or commercial positions; 3-year cooling-off |
...
## XI.3 — The Independent Legislative Classification Body
...
Members serve non-renewable eight-year terms, staggered so that three seats are filled every thirty-two months. No member may have held elected office, a government position, or a lobbying role within five years of appointment. The Triple Key (XI.2) governs appointment and removal.
...
1. **Domain Test** — does the subject matter fall within an Assembly-Locked Domain (I.10)? If yes, the legislation is classified as Assembly Baseline regardless of its origin.
...
3. **Regulatory Gravity Test** — applying the indicators of VII.2, does the proposed legislation create de facto compliance pressure beyond participating states? If yes, the legislation is classified as External Reach and the procedural safeguards of VII.4–VII.6 apply.
4. **Overlap Test** — does the subject matter intersect with another Hestia's domain? If yes, the ILCB identifies the overlap and, if necessary, initiates the conflict resolution procedure of VI.7.
...
# Title XIII — Entry into Force

**XIII.1 — The Founding Hestia.** Upon ratification, the existing acquis becomes the Founding Hestia. Existing relationships are mapped to Charter standings by the Independent Review Commission within three years.

**XIII.2 — Foundation Coalition.** Five states constituting a viable Assembly may ratify this Charter, inviting others to accede at any standing.

**XIII.3 — Relationship to Existing Treaties.** This Charter supersedes conflicting provisions of existing EU treaties among ratifying states. Transitional protocols for non-ratifying state interdependencies negotiated within two years.

---

## Note on Numbering

Articles in this Charter are identified by Title and sequence within Title — e.g. **VI.2** denotes the second article of Title VI. This scheme replaces the sequential article numbering of earlier drafts (Articles 1–45). Each Title may add or reorder its own articles without disturbing references in other Titles.
