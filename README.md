...
The Hearth Charter replaces the binary in-or-out model of EU membership with a spectrum of four standings — **Member**, **Inner Union Associate**, **Outer Union Associate**, and **Strategic Partner** — each participating in a different mix of 16 policy-domain Hestias.
